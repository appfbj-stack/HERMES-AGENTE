...
MIGRATIONS = [
    ...
    "ALTER TABLE crm_kanban_columns ADD COLUMN IF NOT EXISTS color VARCHAR(20)",
    "ALTER TABLE crm_kanban_columns ADD COLUMN IF NOT EXISTS is_default BOOLEAN NOT NULL DEFAULT FALSE",
    ...
    "ALTER TABLE crm_tags ADD COLUMN IF NOT EXISTS color VARCHAR(20)",
    "ALTER TABLE crm_leads ADD COLUMN IF NOT EXISTS email VARCHAR(255)",
    "ALTER TABLE crm_leads ADD COLUMN IF NOT EXISTS origin VARCHAR(50) NOT NULL DEFAULT 'manual'",
    "ALTER TABLE crm_leads ADD COLUMN IF NOT EXISTS status VARCHAR(100) NOT NULL DEFAULT 'Novo lead'",
    "ALTER TABLE crm_leads ADD COLUMN IF NOT EXISTS responsible_user_id INTEGER REFERENCES users(id)",
    ...
    "ALTER TABLE crm_leads ADD COLUMN IF NOT EXISTS kanban_column_id INTEGER REFERENCES crm_kanban_columns(id)",
    ...
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS chat_id INTEGER REFERENCES chats(id)",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS contact_name VARCHAR(255)",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS contact_phone VARCHAR(50)",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS status VARCHAR(50) NOT NULL DEFAULT 'open'",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS ai_enabled BOOLEAN NOT NULL DEFAULT TRUE",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS assigned_user_id INTEGER REFERENCES users(id)",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS last_message TEXT",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS last_message_at TIMESTAMPTZ",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW()",
    "ALTER TABLE crm_conversations ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW()",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS legacy_message_id INTEGER REFERENCES messages(id)",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS sender_type VARCHAR(50) NOT NULL DEFAULT 'user'",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS channel VARCHAR(50) NOT NULL DEFAULT 'telegram'",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS content TEXT NOT NULL DEFAULT ''",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW()",
    "ALTER TABLE crm_messages ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW()",
    ...
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS title VARCHAR(255)",
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS description TEXT",
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS due_at TIMESTAMPTZ",
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT 'pendente'",
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS channel VARCHAR(20)",
    "ALTER TABLE crm_followups ADD COLUMN IF NOT EXISTS responsible_user_id INTEGER REFERENCES users(id)",
    ...
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS responsible_user_id INTEGER REFERENCES users(id)",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS due_at TIMESTAMPTZ",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS status VARCHAR(50) NOT NULL DEFAULT 'pendente'",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS priority VARCHAR(50) NOT NULL DEFAULT 'media'",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS lead_id INTEGER REFERENCES crm_leads(id)",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS created_at TIMESTAMPTZ DEFAULT NOW()",
    "ALTER TABLE crm_tasks ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW()",
    "ALTER TABLE crm_activity_logs ADD COLUMN IF NOT EXISTS conversation_id INTEGER REFERENCES crm_conversations(id)",
    "ALTER TABLE crm_activity_logs ADD COLUMN IF NOT EXISTS description TEXT",
    "ALTER TABLE crm_activity_logs ADD COLUMN IF NOT EXISTS metadata_json TEXT",
